...
const UNIT_PRESETS = ['km', 'grams', 'minutes', 'hrs/mins', 'sessions', 'steps', 'calories'];
...
export default function EditHabitScreen() {
  ...
  async function handleSave() {
    ...
    await updateHabit(Number(id), name.trim(), metricType, unit.trim() || 'times', categoryId);
    router.back();
  }
